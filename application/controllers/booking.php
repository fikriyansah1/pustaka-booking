...
$isibooking = ['id_booking' => $this->ModelBooking->kodeOtomatis('booking', 'id_booking'),'tgl_booking' => date('Y-m-d H:m:s'),'batas_ambil' => date('Y-md', strtotime('+2 days', strtotime($tglsekarang))),'id_user' => $where];
